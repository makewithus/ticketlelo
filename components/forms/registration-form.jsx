    ...
    <>
          ...
          <div className="flex gap-2">
            <div className="relative">
              <button
                ...
                className="h-12 px-3 flex items-center gap-1.5 border border-emerald-200 dark:border-slate-800 bg-white dark:bg-slate-900 rounded-xl text-sm text-gray-700 dark:text-slate-300 hover:border-emerald-400 dark:hover:border-emerald-500/50 transition-colors min-w-[100px]"
              >
              ...
              {countryOpen && (
                <div className="absolute left-0 top-full mt-1 w-64 max-h-52 overflow-y-auto z-50 bg-white dark:bg-slate-900 border border-emerald-200 dark:border-slate-700 rounded-xl shadow-2xl shadow-emerald-500/10 dark:shadow-black/50">
                  {COUNTRY_CODES.map((c, idx) => (
                    <button
                      ...
                      className={`w-full flex items-center gap-3 px-4 py-2.5 text-sm hover:bg-emerald-50 dark:hover:bg-emerald-500/10 transition-colors ${selectedCountry === c ? "bg-emerald-50 dark:bg-emerald-500/10 text-emerald-700 dark:text-emerald-400" : "text-gray-700 dark:text-slate-300"}`}
                    >
            ...
            <div className="relative flex-1 input-glow rounded-xl">
              ...
              <Input
                ...
                className="h-12 pl-10 bg-white dark:bg-slate-900 border-emerald-200 dark:border-slate-800 text-gray-900 dark:text-white placeholder:text-gray-400 dark:placeholder:text-slate-600 focus:border-emerald-500 rounded-xl font-mono tracking-wider"
              />
        ...
        <div className="space-y-2">
          ...
          <div className="relative input-glow rounded-xl">
            ...
            <Textarea
              ...
              {...register("message")}
              disabled={isLoading}
              className="pl-10 min-h-[80px] bg-white dark:bg-slate-900 border-emerald-200 dark:border-slate-800 text-gray-900 dark:text-white placeholder:text-gray-400 dark:placeholder:text-slate-600 focus:border-emerald-500 rounded-xl resize-none"
            />
          </div>
        </div>
      ...
      {showSuccessModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
          <div className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 border border-emerald-500/30 rounded-2xl p-6 shadow-2xl max-w-md w-full animate-fade-in">
            ...
            <div className="space-y-4 mb-6">
              <p className="text-slate-300">
                ...
                <strong className="text-emerald-400">User Portal</strong> with
                your credentials:
              </p>

              <div className="bg-black/50 p-4 rounded-xl border border-emerald-500/20 space-y-3">
                <div>
