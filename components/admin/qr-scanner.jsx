...
export function QRScanner() {
  ...
  const getStatusConfig = (status) => {
    switch (status) {
      case "valid":
        return {
          border: "border-[#FF6A00]/40 dark:border-[#FF6A00]/30",
          bg: "bg-orange-50 dark:bg-[#FF6A00]/10",
          icon: (
      ...
      default:
        return {
          border: "border-gray-300 dark:border-[#FF6A00]/20",
    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          {/* Mode Switcher */}
          <div className="flex gap-2 p-1 rounded-xl bg-[#FF6A00]/10 dark:bg-black/50 border border-[#FF6A00]/20 opacity-0 animate-fade-in-up stagger-1">
            <button
              onClick={() => setUseManualEntry(false)}
              className={`flex-1 flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg text-sm font-medium transition-all ${
                !useManualEntry
                  ? "bg-white dark:bg-black text-[#FF6A00] shadow-sm border border-[#FF6A00]/30"
          ...
          {!useManualEntry ? (
            <div className="rounded-2xl border bg-white dark:bg-black/50 border-[#FF6A00]/20 dark:border-[#FF6A00]/20 overflow-hidden opacity-0 animate-scale-in">
              {/* Scanner Header */}
                <div className="flex items-center justify-between px-6 py-4 border-b border-[#FF6A00]/10 dark:border-[#FF6A00]/10">
                ...
                <div className="flex items-center gap-3">
                  {scannerReady && (
                    <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#FF6A00]/10 border border-[#FF6A00]/20">
                  ...
                  {isProcessing && (
                    <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#FF6A00]/10 border border-[#FF6A00]/20">
                      <div className="w-3.5 h-3.5 border-2 border-[#FF6A00] border-t-transparent rounded-full animate-spin" />
                      <span className="text-xs font-medium text-[#FF6A00]">
                        Processing...
                      </span>
                    </div>
              ...
              <div className="bg-black relative">
                <div className="text-center text-white text-sm py-3 px-4 bg-black border-b border-[#FF6A00]/20 flex items-center justify-center gap-2">
            ...
            <div className="rounded-2xl border bg-white dark:bg-black/50 border-[#FF6A00]/20 p-8 opacity-0 animate-scale-in">
              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  <div className="relative input-glow rounded-xl">
                    ...
                    <Input
                      ...
                      className="h-12 pl-10 text-base bg-gray-50 dark:bg-black border-[#FF6A00]/30 dark:border-[#FF6A00]/30 text-gray-900 dark:text-white placeholder:text-gray-400 dark:placeholder:text-slate-600 focus:border-[#FF6A00] dark:focus:border-[#FF6A00] rounded-xl"
                      autoFocus
                ...
                <Button
                  ...
                  disabled={isProcessing}
                  className="w-full h-12 gap-2 bg-[#FF6A00] hover:bg-[#E65C00] hover:opacity-90 text-white font-bold shadow-lg shadow-[#FF6A00]/20 rounded-xl"
                >
                  {isProcessing ? (
                    <>
        ...
        <div className="lg:col-span-1">
          <div className="rounded-2xl border bg-white dark:bg-black/50 border-[#FF6A00]/20 p-6 h-full opacity-0 animate-fade-in-up stagger-2">
            ...
            <div className="space-y-3 max-h-[500px] overflow-y-auto">
              {scanHistory.length === 0 ? (
                <div className="text-center py-12">
                  <div className="w-14 h-14 rounded-full bg-[#FF6A00]/10 flex items-center justify-center mx-auto mb-3">
                    <ScanLine className="w-7 h-7 text-[#FF6A00]/40" />
                  </div>
                  ...
                  return (
                    <div
                      ...
                      className={`p-3.5 rounded-xl text-sm border-l-4 transition-all ${
                        isValid
                          ? "bg-orange-50 dark:bg-[#FF6A00]/5 border-[#FF6A00]"
