  ...
  return (
    <div className="min-h-screen bg-black text-white relative overflow-x-hidden">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-0 right-0 w-96 h-96 bg-[#FF6A00]/10 rounded-full blur-3xl animate-pulse" />
        <div className="absolute bottom-0 left-0 w-96 h-96 bg-[#FFD60A]/10 rounded-full blur-3xl animate-pulse delay-1000" />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-[#FF6A00]/5 rounded-full blur-3xl animate-pulse delay-500" />
      </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center min-h-[500px]">
            ...
            <div className="order-2 lg:order-1 flex flex-col">
              <motion.div
                ...
                className="inline-flex items-center gap-2 px-4 py-2 bg-[#FF6A00]/10 border border-[#FF6A00]/20 rounded-md mb-6 w-fit"
              >
              ...
              >
                Event Registration,
                <br />
                <span className="text-[#FF6A00]">MADE EFFORTLESS!</span>
              </motion.h1>
      ...
      <section className="relative overflow-hidden py-3">
        <ScrollVelocityContainer>
          <ScrollVelocityRow
            baseVelocity={8}
            direction={1}
            className="text-2xl sm:text-4xl font-bold text-[#FF6A00]/20"
          >
            <span className="px-6">Digital Passes</span>
            <span className="px-2 text-[#FFD60A]/30">•</span>
      ...
      <section className="relative py-16 sm:py-24 px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto">
          ...
          >
            <div className="inline-flex items-center justify-center w-20 h-20 bg-[#FF6A00]/10 border-2 border-[#FF6A00]/30 rounded-2xl mb-6">
              <Sparkles className="w-10 h-10 text-[#FFD60A]" />
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-10 max-w-3xl mx-auto">
              {[
                ...
                >
                  <item.icon className="w-5 h-5 text-[#FFD60A] flex-shrink-0" />
      ...
      >
        <div className="max-w-7xl mx-auto">
          {isLoading ? (
            ...
            >
              <div className="inline-flex items-center justify-center w-20 h-20 bg-[#FF6A00]/10 border border-[#FF6A00]/20 rounded-2xl mb-6">
                <Calendar className="w-10 h-10 text-[#FFD60A]" />
              </div>
            ...
            >
              <button
                ...
                className="mb-8 flex items-center gap-2 text-sm text-gray-400 hover:text-white border border-white/10 px-4 py-2 rounded-lg hover:border-[#FF6A00]/40 hover:bg-white/5 transition-all"
              >
                <ArrowLeft className="w-4 h-4" /> Back to Events
              </button>
              <div className="bg-zinc-950 border border-zinc-800 rounded-2xl p-8">
                <div className="flex items-center gap-3 mb-2">
                  <div className="inline-flex items-center justify-center w-10 h-10 bg-[#FF6A00]/10 border border-[#FF6A00]/20 rounded-xl">
                    <Ticket className="w-5 h-5 text-[#FFD60A]" />
                  </div>
            ...
            <div>
              ...
              >
                <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-4">
                  Upcoming <span className="text-[#FF6A00]">Events</span>
                </h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
                {events.map((event, index) => (
                  <motion.div
                    ...
                    className="group relative bg-gradient-to-br from-zinc-900 to-zinc-950 border border-zinc-800 hover:border-[#FF6A00]/40 rounded-2xl overflow-hidden cursor-pointer transition-all duration-300 flex flex-col hover:shadow-[0_0_30px_rgba(254,118,11,0.12)]"
                  >
                    <div className="h-0.5 bg-[#FF6A00] hover:bg-[#E65C00] opacity-0 group-hover:opacity-100 transition-opacity" />
                    <div className="p-6 flex flex-col flex-1">
                      <h3 className="text-xl font-bold mb-2 group-hover:text-[#FF6A00] transition-colors line-clamp-1">
                        {event.name}
                      </h3>
                      ...
                      <div className="space-y-3 mb-6">
                        <div className="flex items-center gap-3 text-sm">
                          <div className="w-8 h-8 rounded-lg bg-[#FF6A00]/10 border border-[#FF6A00]/20 flex items-center justify-center shrink-0">
                      ...
                      <div className="mt-auto">
                        <button className="w-full py-3 bg-[#FFD60A] text-white font-bold rounded-lg flex items-center justify-center gap-2 group-hover:bg-[#FF6A00] group-hover:text-white transition-all">
                          Register Now
            ...
            {[
              ...
              >
                <div className="text-center">
                  <div className="inline-flex items-center justify-center w-16 h-16 bg-[#FF6A00]/10 border border-[#FF6A00]/20 rounded-xl mb-6">
                    <item.icon className="w-8 h-8 text-[#FFD60A]" />
                  </div>
                  <div className="text-sm font-bold text-[#FF6A00] mb-3 tracking-widest">
                    STEP {item.step}
                  </div>
      ...
      <section className="relative py-16 sm:py-24 px-4 sm:px-6 lg:px-8 bg-zinc-950">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <a href="#events">
              <button className="px-10 py-4 bg-[#FFD60A] text-white font-bold rounded-lg text-lg inline-flex items-center gap-2 hover:bg-[#FF6A00] hover:text-white transition-all shadow-lg shadow-[#FFD60A]/20">
                Browse Events
                <ArrowRight className="w-5 h-5" />
              </button>
            </a>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <p className="text-gray-500 text-sm">
              ...
              <Link
                href="/host-event"
                className="text-[#FF6A00] hover:text-[#FFD60A] transition-colors font-semibold"
              >
